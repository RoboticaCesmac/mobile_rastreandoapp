...
export default function SeusExamesDeRastreioColoDeUteroFeminino() {
        ...
        const fetchExames = async () => {
            if (user) {
                ...
                if (userDoc.exists()) {
                    ...
                    setProximoExame(userData.proximoExameColoDeUtero || null);
                    setExamesAnteriores(userData.examesAnterioresColoDeUtero || []);
                }
            }
        };
        fetchExames();
    ...
    const registrarExame = (date: Date, resultado: string) => {
        ...
        if (user) {
            ...
            const updateData: any = {
                examesAnterioresColoDeUtero: examesAtualizados,
            };

            if (dataProximoExame) {
                updateData.proximoExameColoDeUtero = dataProximoExame;
            }
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.header}>
                <Text style={styles.title}>Seus Exames de Rastreio - Colo do Útero</Text>
            </View>
            ...
            <View style={styles.sectionContainer}>
                ...
                <Text style={styles.nextExamText}>
                    {proximoExame
                        ? `Citologia Oncótica - ${formatDate(proximoExame)}`
                ...
                <View style={styles.modalContainer}>
                    <View style={styles.modalContent}>
                        ...
                        <TouchableOpacity
                            ...
                            onPress={() => {
                                setExameSelecionado('Citologia Oncótica');
                                showDatePicker();
                                closeModal();
                            }}
                        >
                            <Text style={styles.modalButtonText}>Citologia Oncótica</Text>
                        </TouchableOpacity>
