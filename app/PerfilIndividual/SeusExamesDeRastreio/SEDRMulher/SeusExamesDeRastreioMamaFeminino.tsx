...
export default function SeusExamesDeRastreioMamaFeminino() {
        ...
        const fetchExames = async () => {
            if (user) {
                ...
                if (userDoc.exists()) {
                    ...
                    setProximoExame(userData.proximoExameMama || null);
                    setExamesAnteriores(userData.examesAnterioresMama || []);
                }
            }
        };
        fetchExames();
    ...
    const registrarExame = (date: Date, resultado: string) => {
        ...
        if (user) {
            ...
            const updateData: any = {
                examesAnterioresMama: examesAtualizados,
            };

            if (dataProximoExame) {
                updateData.proximoExameMama = dataProximoExame;
            }
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.header}>
                <Text style={styles.title}>Seus Exames de Rastreio - Mama</Text>
            </View>
            ...
            <View style={styles.sectionContainer}>
                ...
                <Text style={styles.nextExamText}>
                    {proximoExame
                        ? `Mamografia - ${formatDate(proximoExame)}`
                ...
                <View style={styles.modalContainer}>
                    <View style={styles.modalContent}>
                        ...
                        <TouchableOpacity
                            ...
                            onPress={() => {
                                setExameSelecionado('Mamografia');
                                showDatePicker();
                                closeModal();
                            }}
                        >
                            <Text style={styles.modalButtonText}>Mamografia</Text>
                        </TouchableOpacity>
